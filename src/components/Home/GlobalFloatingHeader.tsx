...
import Automation from '../Header/UserPreferences/Automation'
import { useMarketMetadata } from '@context/MarketMetadata'

const Wallet = loadable(() => import('../Header/Wallet'))

export default function GlobalFloatingHeader() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 top-4 flex justify-center pointer-events-none z-50">
        <motion.div
          className={`w-full max-w-6xl mx-4 bg-white border rounded-3xl shadow-lg flex items-center justify-between px-4 py-2 pointer-events-auto transition-all duration-300 ${
            isScrolled
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-x-0 top-20 flex justify-center pointer-events-none z-40 lg:hidden">
          <motion.div
            className="w-full max-w-6xl mx-4 bg-white border border-gray-100 rounded-xl shadow-lg pointer-events-auto"
