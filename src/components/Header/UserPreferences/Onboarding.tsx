    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          animate={{
            scale: showOnboardingModule ? 1.1 : 1,
        ...
        >
          <motion.div
            initial={false}
            animate={{
              opacity: showOnboardingModule ? 1 : 0,
              scale: showOnboardingModule ? 1 : 0.5,
              rotate: showOnboardingModule ? 0 : 180
            }}
            transition={{
              duration: 0.2,
              type: 'spring',
      ...
      >
        ...
        {showTooltip && (
          ...
          >
            Show the onboarding tutorial module on the homepage.
